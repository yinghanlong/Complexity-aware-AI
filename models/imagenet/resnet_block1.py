...
__all__ = ['ResNet', 'resnet18_b1', 'resnet34_b1', 'resnet50_b1', 'resnet101_b1',
           'resnet152_b1']
...
def resnet18_b1(pretrained=False, **kwargs):
...
def resnet34_b1(pretrained=False, **kwargs):
...
def resnet50_b1(pretrained=False, **kwargs):
...
def resnet101_b1(pretrained=False, **kwargs):
...
def resnet152_b1(pretrained=False, **kwargs):
