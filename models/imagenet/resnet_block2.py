...
__all__ = ['ResNet', 'resnet18_b2', 'resnet34_b2', 'resnet50_b2', 'resnet101_b2',
           'resnet152_b2']
...
class ResNet(nn.Module):
    ...
    def forward(self, x):
        ...
        x = x + y #add hard class correction
        x = self.layer3(x)
        x = self.layer4(x)
...
def resnet18_b2(pretrained=False, **kwargs):
...
def resnet34_b2(pretrained=False, **kwargs):
...
def resnet50_b2(pretrained=False, **kwargs):
...
def resnet101_b2(pretrained=False, **kwargs):
...
def resnet152_b2(pretrained=False, **kwargs):
