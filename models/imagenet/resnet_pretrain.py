...
__all__ = ['ResNet', 'resnet18_p', 'resnet34_p', 'resnet50_p', 'resnet101_p',
           'resnet152_p']
...
class ResNet(nn.Module):
    ...
    def forward(self, x):
        ...
        # Add layers
        #xnew = outputx + y #sum
        xnew = torch.cat((outputx, y),1) #concat #add hard class correction
        exit1 = self.conv1_exit1(xnew)
        exit1 = self.avgpool(exit1)
        exit1 = exit1.view(exit1.size(0), -1)
        exit_enable = None#self.binary_classifier(exit1)
...
def resnet18_p(pretrained=False, **kwargs):
...
def resnet34_p(pretrained=False, **kwargs):
...
def resnet50_p(pretrained=False, **kwargs):
...
def resnet101_p(pretrained=False, **kwargs):
...
def resnet152_p(pretrained=False, **kwargs):
