...
__all__ = ['resnet20_cifar_bloc2', 'resnet32_cifar_bloc2', 'resnet44_cifar_bloc2', 'resnet56_cifar_bloc2']
...
class ResNetCifar_bloc2(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=NUM_CLASSES):
        ...
        self.inplanes =  16 #64
        super(ResNetCifar_bloc2, self).__init__()
        ...
        #self.binary_classifier = nn.Linear(800, 2)#nn.Linear(800, 2)
    ...
    def forward(self, x):
        ...
        #exit_enable = self.binary_classifier(exit1)#.clone().detach())
...
def resnet20_cifar_bloc2(**kwargs):
    model = ResNetCifar_bloc2(BasicBlock, [3, 3, 3], **kwargs)
    return model

def resnet32_cifar_bloc2(**kwargs):
    model = ResNetCifar_bloc2(BasicBlock, [5, 5, 5], **kwargs)
    return model

def resnet44_cifar_bloc2(**kwargs):
    model = ResNetCifar_bloc2(BasicBlock, [7, 7, 7], **kwargs)
    return model

def resnet56_cifar_bloc2(**kwargs):
    model = ResNetCifar_bloc2(BasicBlock, [9, 9, 9], **kwargs)
    return model
