...
__all__ = ['resnet20_cifar_bloc1', 'resnet32_cifar_bloc1', 'resnet44_cifar_bloc1', 'resnet56_cifar_bloc1']
...
class ResNetCifar_bloc1(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=NUM_CLASSES):
        ...
        self.inplanes =  16
        super(ResNetCifar_bloc1, self).__init__()
        ...
        # Define early exit layers
        self.linear_exit1 = nn.Linear(800, num_classes)
        self.binary_classifier = nn.Linear(800, 2)
        self.layer3 = self._make_layer(self.layer_gates[2], block, 64, layers[2], stride=2)
        self.avgpool = nn.AvgPool2d(7, stride=1)
        self.fc = nn.Linear(256, num_classes)#Note: only use the num of hard classes at the third block
...
def resnet20_cifar_bloc1(**kwargs):
    model = ResNetCifar_bloc1(BasicBlock, [3, 3, 3], **kwargs)
    return model

def resnet32_cifar_bloc1(**kwargs):
    model = ResNetCifar_bloc1(BasicBlock, [5, 5, 5], **kwargs)
    return model

def resnet44_cifar_bloc1(**kwargs):
    model = ResNetCifar_bloc1(BasicBlock, [7, 7, 7], **kwargs)
    return model

def resnet56_cifar_bloc1(**kwargs):
    model = ResNetCifar_bloc1(BasicBlock, [9, 9, 9], **kwargs)
    return model
